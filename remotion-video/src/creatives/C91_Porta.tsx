...
const BEATS: Beat[] = [
  { at: 0, bg: BLK, render: t => (
    <div style={Center}>
      <Slam t={t} at={DELAY + 0.1} size={124} color={OFF} rot={-2}>Você já sabe.</Slam>
  ...
  { at: DELAY + 3.6, bg: RED, render: t => (
    <div style={Center}>
      <Slam t={t} at={DELAY + 3.61} size={124} color={OFF} rot={2}>Você já sabe.</Slam>
      <div style={{ marginTop: 32 }}>
  ...
  { at: DELAY + 7.03, bg: OFF, render: t => (
    <div style={Center}>
      <Slam t={t} at={DELAY + 7.04} size={136} color={BLK} rot={-2}>O que falta?</Slam>
    </div>
  )},
  { at: DELAY + 8.51, bg: BLK, render: t => (
    <div style={Center}>
      <Slam t={t} at={DELAY + 8.52} size={205} color={RED} rot={2}>A porta.</Slam>
    </div>
  )},
  { at: DELAY + 9.85, bg: RED, render: t => (
    <div style={Center}>
      <Slam t={t} at={DELAY + 9.86} size={390} color={OFF}>+530</Slam>
  ...
  { at: DELAY + 12.5, bg: OFF, render: t => (
    <div style={Center}>
      <Slam t={t} at={DELAY + 12.51} size={270} color={BLK}>+9.000</Slam>
      <div style={{ marginTop: 30 }}>
  ...
  { at: DELAY + 16.76, bg: RED, render: t => (
    <div style={Center}>
      <Slam t={t} at={DELAY + 16.77} size={132} color={OFF} rot={2}>Ferramentas</Slam>
      <div style={{ marginTop: 28 }}>
  ...
  { at: DELAY + 19.66, bg: OFF, render: t => (
    <div style={Center}>
      <Slam t={t} at={DELAY + 19.67} size={280} color={BLK}>10 mil</Slam>
      <div style={{ marginTop: 30 }}>
  ...
  { at: DELAY + 22.01, bg: BLK, render: t => (
    <div style={Center}>
      ...
      <Slam t={t} at={DELAY + 22.66} size={160} color={RED} rot={-2} style={{ marginTop: 16 }}>tá aberta.</Slam>
    </div>
  )},
  { at: DELAY + 23.89, bg: RED, render: t => (
    <div style={Center}>
      <Slam t={t} at={DELAY + 23.9} size={160} color={OFF} rot={2}>E o teste</Slam>
      <Slam t={t} at={DELAY + 24.66} size={185} color={BLK} rot={2} style={{ marginTop: 16 }}>é grátis.</Slam>
    </div>
  )},
