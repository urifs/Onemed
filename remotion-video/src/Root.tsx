...
import { V41_Diag, V41_DURATION } from './creatives/V41_Diag';
import { V42_Prescricao, V42_DURATION } from './creatives/V42_Prescricao';
...
import { PF04_Prismface, PF04_DURATION } from './creatives/PF04_Prismface';
...
const CREATIVES: Array<[string, React.FC, number]> = [
  ...
  ['V41-Diag', V41_Diag, V41_DURATION],
  ['V42-Prescricao', V42_Prescricao, V42_DURATION],
  ...
  ['PF04-Prismface', PF04_Prismface, PF04_DURATION],
];
