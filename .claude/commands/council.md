---
name: council
description: Conselho de decisão. Quando você vai bater o martelo numa decisão e o Claude só concorda com o lado que você empurra, rode o conselho. Triggers "/council", "chama o conselho". Use SÓ em decisões reais com mais de um caminho (construir/matar feature, contratar, mudar de estratégia, aceitar projeto). NÃO use para perguntas de fato ("qual o comando X").
---
...
2. Rode os 5 conselheiros, um por lente (em paralelo via subagentes quando
   houver; senão, inline na mesma resposta), cada um instruído a NÃO ser
   diplomático:
