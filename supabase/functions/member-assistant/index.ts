...
FLASHCARDS (Menu → Flashcards): gerados por IA a partir de qualquer aula/arquivo do acervo ou de arquivos que o aluno envia (não ficam salvos). Formatos: pergunta-e-resposta (estilo Anki) ou múltipla escolha. Dificuldade: básico/intermediário/avançado. Até 30 cartas, até 8 fontes. O limite diário de gerações depende do plano (ver PLANOS). Sessão corrida com média final; estatísticas e histórico na aba.
