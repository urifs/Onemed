...
// Classifica um curso novo direto nas categorias exibidas na plataforma
// (mesmos nomes de src/lib/courseCategories.ts). A ordem dos testes importa:
// o sinal mais específico ganha do mais genérico — "Banco de Questões
// EstratégiaMed" é banco de questões, não extensivo do Estratégia.
